...
func Routes(app *fiber.App, db *gorm.DB) {
	...
	UsersWeightHeightRoutes(v1, userService, productTokenService, subscriptionService, uwhService)
	ArticleRoutes(v1, userService, productTokenService, subscriptionService, articleService)
	RecipeRoutes(v1, userService, productTokenService, subscriptionService, recipesService)
	...
	LoginStreakRoutes(v1, userService, productTokenService, subscriptionService, loginStreakService)
	BahanMakananRoutes(v1, userService, productTokenService, subscriptionService, bahanMakananService)
	HomeRoutes(v1, userService, productTokenService, subscriptionService, mealService)
